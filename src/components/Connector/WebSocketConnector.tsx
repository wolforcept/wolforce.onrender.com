...
interface WebSocketConnectorProps {
    socket: Socket;
    callback: (() => void)
}

const WebSocketConnector: FC<WebSocketConnectorProps> = ({ socket, callback }) => {

    const [username, setUsername] = useState<string>(LocalStorage.tryGet<string>('username', ''));
