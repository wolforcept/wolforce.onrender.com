...
const RestConnector: FC<RestConnectorProps> = ({ rest, title, gameId, callback }) => {

    const [username, setUsername] = useState<string>(LocalStorage.tryGet<string>(gameId + 'username', ''));
    ...
    function submit() {
        rest.roomcode = roomcode;
        rest.player = {username, animal}
        callback();
    }
